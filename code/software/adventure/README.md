# Adventure by Jeff Tranter

This is a "port" of Jeff Tranter's 'Adventure'. The main code for
the game (`adventure.c`) has not been changed - rather, just enough
...
This will build `adventure.bin`, which can be uploaded to a board that
