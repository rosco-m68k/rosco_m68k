...
int main(int argc, char **argv) 
{
    ...
    char* inputbuffer = (char*) calloc(1,100);
    int len = 100;
    ...
    printf("Available commands: %s%s",
           "clear, color4, color8, trucolor, invert, bold, underline,\n",
           "normal, bell, blink, fill, cursor-pos, screen-size, exit, help\n");

    while(1)
    {
        printf("$ ");
        uart_getline(inputbuffer, len);
        ...
        {
            printf("\x1b" "cGoodbye, you hoopy frood!\n");
            return 0;
        }
