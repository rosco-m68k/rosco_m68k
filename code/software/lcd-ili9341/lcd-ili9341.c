...
static void lcd_init()
{
    ...
    static const uint8_t ILI9341_cmds[] = {
        ...
        0x27,
        0xF2,
        1,        // Gamma Function Disable
        0x00,
        ILI9341_GAMMASET,
        1,        // Gamma curve selected
        0x01,
        ILI9341_GMCTRP1,
        15,        // Set Gamma
        0x0F,
...
static uint16_t colortable[] = {ILI9341_BLACK,
                                ILI9341_BLUE,
                                ILI9341_RED,
                                ILI9341_GREEN,
                                ILI9341_CYAN,
...
int main(int argc, char ** argv)
{
    ...
    do
    {
        ...
        {
            testRLE1(image_data[img],
                     colortable[hadcolor % ELEMENTS(colortable)],
                     colortable[hadcolor + 1 % ELEMENTS(colortable)]);
            hadcolor++;
        }
        ...
        count++;
    } while (!checkchar());        // loop until a char is waiting in UART buffer
