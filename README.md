...
> **Note**: This is the Master branch, which contains the latest release - **Revision 1.2**. If you have a revision 1.2 board (with 1.2 firmware), this is the branch you should be using to build the standard libraries and example programs. If you have a revision 1 board, please use the [current 1.1 release branch](https://github.com/rosco-m68k/rosco_m68k/tree/release/revision-1.1) (or the [1.01 release branch if you have firmware 1.01](https://github.com/rosco-m68k/rosco_m68k/tree/release/revision-1.01)).
