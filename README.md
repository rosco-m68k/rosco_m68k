...
> Note: This is the Version 2.2 release branch. If you are using Firmware 2.2 (regardless of base board revision), this is the branch you should be using to build the standard libraries and example programs.
